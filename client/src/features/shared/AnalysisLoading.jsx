  ...
  return (
    <section className="loading">
      ...
      <div className="analysis-progress">
        <strong>{mode === "improve" ? "Analizando tu mazo…" : "Analizando Commander…"}</strong>
        <span>{stages[stage]}</span>
        <div className="analysis-track"><b></b></div>
        <small>{elapsed}s · etapa {stage + 1}/{stages.length} · el porcentaje exacto depende de EDHREC/Scryfall</small>
      </div>
    </section>
  );
}

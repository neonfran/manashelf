...
echo Iniciando ManaShelf v2.5.48-beta en http://127.0.0.1:%PORT%
start "ManaShelf v2.5.48-beta server" /D "%~dp0" cmd /k "set PORT=%PORT%&& node server.mjs"
timeout /t 1 /nobreak >nul
start "" "http://127.0.0.1:%PORT%/?build=2.5.48-beta"
exit /b 0

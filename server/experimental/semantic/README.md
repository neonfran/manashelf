# LEGACY / DEPRECATED — Semantic v1

> Retained only for historical harness compatibility. LAB3, Knowledge Layer and Builder vNext must use Semantic v2 and must not import this directory at runtime.

# Experimental Semantic Harness

This directory is an isolated pre-LAB3 semantic engine. It is executable, but it is **not** imported by LAB2, `index.mjs`, `public/` or the production `lib/` runtime.

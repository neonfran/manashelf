import {scoreCardForThemeModel,THEME_CORPUS_RUNTIME_MEMBERSHIP_FLOOR} from "../lab3/theme-understanding.mjs";
...
export function auditThemeCorpusSweep({corpus,runtimeCards=[],runtimeSha256=null,minScore=THEME_CORPUS_RUNTIME_MEMBERSHIP_FLOOR,maxThemesPerCard=8,thresholds={},requireIndependentTraining=true}={}){

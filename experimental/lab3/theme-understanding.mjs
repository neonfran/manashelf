export const LAB3_THEME_UNDERSTANDING_VERSION=2;
...
export function inferThemeModel(candidates,{theme="",directFacet=null,minEvidenceCards=6,maxFeatures=36}={}){
  ...
  // Theme Understanding v2 calibrates confidence against contrastive separation.
  ...
  return {version:LAB3_THEME_UNDERSTANDING_VERSION,theme,mode:direct?"semantic_direct":inferred?"semantic_inferred":"external_fallback",directFacet:direct,confidence,evidenceCards:positive.length,positiveWeight:posWeight,externalContrast:contrastFactor,separation,lexicalHits,strongCompactSignal,confidenceGate,features,featureRows:kept};
}

...
import {runtimeThemeFeatures,scoreCardForThemeModel} from "../lab3/theme-understanding.mjs";
...
export function trainThemeProfile({theme,evidence=[],sourceEvidence={},seed="manashelf-theme-corpus-v1",trustGate=DEFAULT_THEME_TRUST_GATE,maxFeatures=40}={}){
  ...
  const learned=featureModel(train,{maxFeatures}),model={version:THEME_PROFILE_VERSION,theme,mode:"semantic_inferred",source:"theme_corpus",sourceEvidence:{...sourceEvidence},confidence:0,evidenceCards:train.filter(x=>x.label===1).length,features:learned.features,featureRows:learned.featureRows,directFacet:null};
